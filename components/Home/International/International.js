...
const International = (intDatas) => {
    ...
    return (
        <div className='container mx-auto lg:pb-5 lg:border-b  border-gray-200'>
            <h2 className='text-2xl pt-24 lg:pt-5 pb-5 text-red-500 font-bold'><span className='text-black'> <Link href='international' >International</Link> </span><ChevronRightIcon /></h2>
