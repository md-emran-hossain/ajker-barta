...
it('render ScienceTechnology component without crashing', () => {
  const div = document.createElement('div')
  ReactDOM.render(<ScienceTechnology />, div)
})

it('testing ScienceTechnology with props', () => {
  const { getByTestId } = render(<ScienceTechnology testArr={testArr} />)
  expect(getByTestId('scienceTechnologyId')).toBeTruthy()
})

it('maching snapshot', () => {
  const tree = renderer.create(<ScienceTechnology />)
