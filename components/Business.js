  ...
  return (
    <div className='mb-6'>
      <div className="container">
        <h1 className='flex items-center justify-start gap-2 ml-2 text-xl mb-1 cursor-pointer font-medium text-blue-900'>Business <BsArrowRight className='text-red-600' /></h1>
